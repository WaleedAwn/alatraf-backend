...
namespace AlatrafClinic.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251207212747_InitialCreate")]
            ...
            modelBuilder.Entity("AlatrafClinic.Domain.TherapyCards.TherapyCardTypePrices.TherapyCardTypePrice", b =>
                {
                    ...
                    b.ToTable("TherapyCardTypePrices");
                });
            ...
            modelBuilder.Entity("AlatrafClinic.Domain.Inventory.Purchases.PurchaseInvoice", b =>
                {
                    ...
                    b.OwnsMany("AlatrafClinic.Domain.Inventory.Purchases.PurchaseItem", "Items", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("PurchaseInvoiceId")
                                .HasColumnType("int");

                            b1.Property<int>("PurchaseInvoiceId1")
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("StoreItemUnitId")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("PurchaseInvoiceId");

                            b1.HasIndex("PurchaseInvoiceId1");

                            b1.HasIndex("StoreItemUnitId");
                            ...
                            b1.HasOne("AlatrafClinic.Domain.Inventory.Purchases.PurchaseInvoice", "PurchaseInvoice")
                                .WithMany()
                                .HasForeignKey("PurchaseInvoiceId1")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.HasOne("AlatrafClinic.Domain.Inventory.Stores.StoreItemUnit", "StoreItemUnit")
                                .WithMany()
                                .HasForeignKey("StoreItemUnitId")
                                .OnDelete(DeleteBehavior.Restrict)
                                .IsRequired();

                            b1.Navigation("PurchaseInvoice");

                            b1.Navigation("StoreItemUnit");
                        });
            ...
            modelBuilder.Entity("AlatrafClinic.Domain.RepairCards.Orders.Order", b =>
                {
                    ...
                    b.OwnsMany("AlatrafClinic.Domain.RepairCards.Orders.OrderItem", "OrderItems", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.HasOne("AlatrafClinic.Domain.Inventory.Items.ItemUnit", "ItemUnit")
                                .WithMany()
                                .HasForeignKey("ItemUnitId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
                            ...
                            b1.HasOne("AlatrafClinic.Domain.RepairCards.Orders.Order", "Order")
                                .WithMany()
                                .HasForeignKey("OrderId1")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.Navigation("ItemUnit");
